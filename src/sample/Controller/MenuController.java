...
public class MenuController {
    ...
    public void handleCoffeeOrdering() {
        createNewStage("../View/Coffee.fxml",
                "RUCAFE: Coffee Menu", 375, 400);
    }
    ...
    public void handleDonutOrdering() {
        createNewStage("../View/Donut.fxml",
                "RUCAFE: Donut Menu", 450, 400);
    }
    ...
    public void handleCheckCurrentOrder() {
        createNewStage("../View/CurrentOrder.fxml",
                "RUCAFE: Current Order", 425, 400);
    }
    ...
    public void handleCheckOrders() {
        createNewStage("../View/StoreOrders.fxml",
                "RUCAFE: All Orders", 375, 350);
    }
